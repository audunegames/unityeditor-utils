...
{ 
  ...
  public static class RectExtensions
  {
    ...
    public static Rect MoveLeft(this Rect rect, float delta)
    {
      return new Rect(rect.x - delta, rect.y, rect.width, rect.height);
    }

    // Move a rect to the right
    public static Rect MoveRight(this Rect rect, float delta)
    {
      return new Rect(rect.x + delta, rect.y, rect.width, rect.height);
    }

    // Move a rect upwards
    public static Rect MoveUp(this Rect rect, float delta)
    {
      return new Rect(rect.x, rect.y - delta, rect.width, rect.height);
    }

    // Move a rect downwards
    public static Rect MoveDown(this Rect rect, float delta)
    {
      return new Rect(rect.x, rect.y + delta, rect.width, rect.height);
    }
    #endregion

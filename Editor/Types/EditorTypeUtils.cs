...
namespace Audune.Utils.Editor
{
  ...
  public static class EditorTypeUtils
  {
    ...
    public static GenericMenu CreateGenericMenuForChildTypes(this TypeReferenceAttribute attribute, Type selectedType, Action<Type> onClicked)
    {
      if (attribute == null)
        throw new ArgumentNullException(nameof(attribute));

      var menu = new GenericMenu();
      foreach (var type in TypeUtils.GetChildTypes(attribute))

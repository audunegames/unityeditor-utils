...
namespace Audune.Utils.UnityEditor.Editor
{
  ...
  public class ReorderableListBuilder
  {
    ...
    // Toggle to make list element draggable
    ...
    #region Draggable building methods
    // Set the draggable property
    public ReorderableListBuilder SetDraggable(bool draggable)
    {
